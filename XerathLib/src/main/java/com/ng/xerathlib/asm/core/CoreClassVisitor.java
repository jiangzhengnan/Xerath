...
public class CoreClassVisitor extends BaseClassVisitor {
    ...
    public void visit(final int version, final int access, final String name, final String signature, final String superName, final String[] interfaces) {
        ...
        if (mHookHelper != null) {
            mHookHelper.onVisitClass(version, access, name, signature, superName, interfaces);
        }
    }
        ...
        if (mHookHelper != null) {
            ...
            if ("Lorg/json/JSONObject;".equals(descriptor)) {
                ...
                if ((access & ACC_STATIC) != 0) {
                    ...
                    mHookHelper.getParams().getStaticFiledList().add(temp);
                } else {
                    //LogUtil.print("抓取 [成员] 变量: owner:" + owner + " name:" + name + " desc:" + descriptor);
                    mHookHelper.getParams().getFiledList().add(temp);
                }
            }
        }
    ...
    public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
        ...
        if (!isInterface && mv != null && !name.equals("<init>")) {
            ...
            mv = new CoreMethodAdapter(mHookHelper, access, name, descriptor, mv, owner);
        }
        return mv;
    }
